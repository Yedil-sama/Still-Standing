...
[CreateAssetMenu(menuName = "SO/Effects/Passives/TakeDamageStacking", fileName = "TakeDamageStacking")]
public class TakeDamageStackingEffect : ItemPassiveEffect
{
    ...
    public override void OnTakeDamage(Character owner, float amount)
    {
