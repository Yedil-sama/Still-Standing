...
[CreateAssetMenu(menuName = "SO/Effects/Passives/CastSpellOrTakeDamageStacking", fileName = "CastSpellOrTakeDamageStacking")]
public class CastSpellOrTakeDamageStackingEffect : ItemPassiveEffect
{
    ...
    public override void OnCast(Character owner, Ability spell, Character target) => TryAddStack(owner);
